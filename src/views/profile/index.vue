    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <div class="card kjfs">
          ...
          <ul>
            <li><router-link to="demo/comment" class="kjfs kjfs-bluee"><span><i class="el-icon-tickets fa-2x"></i></span><span>发表文章</span></router-link></li>
            <li><router-link to="/big-data" class="kjfs kjfs-pinkk"><span><i class="fa fa-hand-stop-o fa-2x"></i></span><span>数据展示</span></router-link></li>
          ...
          <ul>
            <li><router-link to="demo/upload" class="kjfs kjfs-grennn"><span><i class="fa fa-cloud-upload fa-2x"></i></span><span>文件上传</span></router-link></li>
            <li><router-link to="user/user-role" class="kjfs kjfs-purplee"><span><i class="fa el-icon-menu fa-2x"></i></span><span>菜单管理</span></router-link></li>
            <li><router-link to="demo/mavonEditor" class="kjfs kjfs-lightBluee"><span><i class="fa fa-file-code-o fa-2x"></i></span><span>编辑器</span></router-link></li>
          </ul>
        </div>
      </el-col>
      <el-col :span="8">
        ...
        <div class="card bbxx">
          ...
          <div class="table">
            ...
            <p><span class="tit">获取渠道</span>
              <span class="gitbox">
                  <a target="_blank" href="https://github.com/dinghouzhu/vue-admin-wonderful"><el-button type="primary" icon="el-icon-download" size="small">github</el-button></a>
                  <a ><el-button type="primary" icon="el-icon-download" size="small">码云(暂未)</el-button></a>
                </span>
            </p>
          </div>
        </div>
...
<script>
     import LineEcharts from "../../components/EChartsNeo/lineEcharts"
