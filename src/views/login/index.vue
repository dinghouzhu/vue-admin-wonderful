                            ...
                            <div class="el-row" span="24">
                                <div class="el-col el-col-16">
                                    <el-input type="text" maxlength="4" placeholder="请输入验证码"
                                              ...
                                              @keyup.enter.native.stop="submitForm('ruleForm')" ref="code"></el-input>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            initRandomQuotations() {
                this.quotations = this.classicQuotationsList[Math.floor(Math.random() * this.classicQuotationsList.length)]
            },
                    ...
                    if (valid) {
                        ...
                        _this.$axios({
                            ...
                            if (res.data.code == 200) {
                                setSession("token", res.data.data.userInfo.token);
                                setSession("userInfo", {userName: _this.ruleForm.userName, time: new Date().getTime()})
                                this.$router.push("/");
                                _this.$message.success(`${this.currentTime}欢迎回来！`);
                            } else {
                                _this.$message.error(res.msg);
                            }
                        })
                            .catch(res => {
                                _this.$message.error('接口出现问题!');
                            })
